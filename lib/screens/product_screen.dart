...
class _ProductState extends State<Product> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Magic Soil(All purpose Potting Soil'),
        elevation: 0.0,
        actions: <Widget>[
          Padding(
              ...
              child: Padding(
                ...
                child: ListView(
                  children: <Widget>[
                    ...
                    Text(
                      'Magic Soil (All purpose Potting Soil) - 5 kg',
                      style: TextStyle(
                        fontSize: 17.0,
                      ),
                    ),
                        ...
                        children: <Widget>[
                          ...
                          RichText(
                            text: TextSpan(
                              ...
                              children: <TextSpan>[
                                TextSpan(
                                  text:
                                      'Aquagri Processing Pvt. Ltd. (Joint Venture of IFFCO eBazar Ltd.)',
                                  style: TextStyle(
                                    fontSize: 12.0,
                                  ),
                                ),
                          ...
                          RichText(
                            text: TextSpan(
                              ...
                              children: <TextSpan>[
                                TextSpan(
                                  text: 'Aquagri Greentech Pvt. Ltd.',
                                  style: TextStyle(
                                    fontSize: 12.0,
                                  ),
                                ),
